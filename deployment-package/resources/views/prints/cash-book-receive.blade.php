...
<head>
    ...
    <title>Cash Book - Receive Side</title>
    <style>
        body {
...
<body>
    ...
    <div class="cash-details">
        <table class="cash-book-table">
            <tr>
                <td><strong>Previous Day Cash in Hand:</strong></td>
                <td class="amount">₨{{ number_format($data->previous_day_balance ?? 0, 2) }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="totals">
        <table>
            <tr>
                <td><strong>Today's Received Amount:</strong></td>
                <td class="amount">₨{{ number_format($data->total_received ?? 0, 2) }}</td>
            </tr>
            <tr>
                <td><strong>Previous Day's Balance:</strong></td>
                <td class="amount">₨{{ number_format($data->previous_day_balance ?? 0, 2) }}</td>
            </tr>
            <tr style="border-top: 2px solid #000;">
                <td><strong>Total Cash in Hand:</strong></td>
                <td class="amount">₨{{ number_format($data->total_cash_in_hand ?? 0, 2) }}</td>
            </tr>
        </table>
    </div>
