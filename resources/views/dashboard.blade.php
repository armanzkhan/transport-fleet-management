        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                ...
                <div class="btn-group" role="group" style="position: relative;">
                    <button type="button" class="btn btn-outline-primary dropdown-toggle" id="exportDropdown" aria-expanded="false" onclick="toggleExportDropdown()">
                    ...
                    <ul class="dropdown-menu" id="exportMenu">
                        ...
                        <li><a class="dropdown-item" href="{{ route('data-export-import.index') }}">
