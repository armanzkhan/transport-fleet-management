                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('vrn') is-invalid @enderror" 
                                   id="vrn" name="vrn" value="{{ old('vrn') }}" required>
                            @error('vrn')
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('driver_contact') is-invalid @enderror" 
                                   id="driver_contact" name="driver_contact" value="{{ old('driver_contact') }}" required>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('induction_date') is-invalid @enderror" 
                                   id="induction_date" name="induction_date" value="{{ old('induction_date') }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('token_tax_expiry') is-invalid @enderror" 
                                   id="token_tax_expiry" name="token_tax_expiry" value="{{ old('token_tax_expiry') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('dip_chart_expiry') is-invalid @enderror" 
                                   id="dip_chart_expiry" name="dip_chart_expiry" value="{{ old('dip_chart_expiry') }}">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('tracker_name') is-invalid @enderror" 
                                   id="tracker_name" name="tracker_name" value="{{ old('tracker_name') }}">
                            @error('tracker_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="url" class="form-control @error('tracker_link') is-invalid @enderror" 
                                   id="tracker_link" name="tracker_link" value="{{ old('tracker_link') }}" 
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('tracker_id') is-invalid @enderror" 
                                   id="tracker_id" name="tracker_id" value="{{ old('tracker_id') }}">
                            @error('tracker_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('tracker_password') is-invalid @enderror" 
                                   id="tracker_password" name="tracker_password" value="{{ old('tracker_password') }}">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="date" class="form-control @error('tracker_expiry') is-invalid @enderror" 
                                   id="tracker_expiry" name="tracker_expiry" value="{{ old('tracker_expiry') }}">
