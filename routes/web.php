...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/data-export-import', [App\Http\Controllers\DataExportImportController::class, 'index'])->name('data-export-import.index');
    Route::post('/data-export-import/export', [App\Http\Controllers\DataExportImportController::class, 'export'])->name('data-export-import.export');
    Route::post('/data-export-import/import', [App\Http\Controllers\DataExportImportController::class, 'import'])->name('data-export-import.import');
    Route::post('/data-export-import/bulk-export', [App\Http\Controllers\DataExportImportController::class, 'bulkExport'])->name('data-export-import.bulk-export');
    Route::post('/data-export-import/download-template', [App\Http\Controllers\DataExportImportController::class, 'downloadTemplate'])->name('data-export-import.download-template');
    Route::get('/data-export-import/statistics', [App\Http\Controllers\DataExportImportController::class, 'getStatistics'])->name('data-export-import.statistics');
